...
<body class="min-h-[100dvh] flex flex-col text-ltblue-txt">

    @include('layouts.navigation')
    <!-- Page Heading -->
    @if (isset($header))
    <header>
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 bg-midnight">
            {{ $header }}
        </div>
    </header>
    @endif
    ...
    <!-- Page Content -->
    <main class="flex flex-col flex-grow items-center bg-midnight text-ltblue-txt">
        {{ $slot }}
    </main>

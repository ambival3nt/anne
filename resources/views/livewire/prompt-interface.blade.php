<div class="container flex h-[90vh] p-fluid-m pt-fluid-l" data-theme="mytheme">
    ...
    <div class="flex flex-col flex-grow pl-fluid-l-xl">
        ...
        <textarea class="textarea textarea-primary rounded-b-sm resize-none font-mono tracking-tight leading-none text-xs h-5/6 w-full bg-transparent focus:outline-1 focus:outline-offset-0" wire:model="outputData" spellcheck="false"></textarea>

        {{-- input--}}
        <textarea class="textarea textarea-primary rounded-t-sm resize-none scroll-none font-mono  leading-none tracking-tight text-xs w-full bg-transparent focus:outline-1 focus:outline-offset-0" wire:click="clearInput" wire:model="userInput" wire:keydown.enter="chatInput" spellcheck="false"></textarea>
